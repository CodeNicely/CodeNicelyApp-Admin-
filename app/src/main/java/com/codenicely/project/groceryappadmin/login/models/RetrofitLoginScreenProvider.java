...
import com.codenicely.project.groceryappadmin.login.api.LoginApi;
...
public class RetrofitLoginScreenProvider implements LoginProvider {
    ...
    public void requestLogin(String mobile, String password,String fcm, final LoginCallback loginCallback) {

        Call<LoginData> loginDataCall = loginApi.requestLogin(mobile, password,fcm);
